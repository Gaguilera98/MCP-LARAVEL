...
#[Name('listar-modelos')]
#[Description('Catálogo de modelos IA del tenant (ai_models + pricing vigente). Incluye platform (proveedor), status active|inactive, available_until, days_until_expiration (null=sin caducidad, negativo=vencido), availability permanente|disponible|expirado, markup_percentage. pricing.unit_definition puede traer prices_by_resolution (ltx/minimax/seedream) o high_res_price_per_second (sora-2-pro) para auditar costo esperado vs cobrado. Útil antes de filtrar generations por model/platform. Lifecycle deprecated/retired del spec no se inventa.')]
